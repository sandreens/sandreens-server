...
const createProduct = async (req, res) => {
    try {
        const { name, description, price, salePrice, badge, category, subcategory, brand, sizes, inStock, stock, isTrending, sku, dimensions, materials, careInstructions, sizesEnabled } = req.body;
        ...
        const product = await Product.create({
            ...
            brand: brand || null,
            sizes: sizes ? (Array.isArray(sizes) ? sizes.filter(Boolean) : (sizes === '' ? [] : [sizes])) : [],
            sizesEnabled: sizesEnabled !== undefined ? (sizesEnabled === 'true' || sizesEnabled === true) : true,
...
const updateProduct = async (req, res) => {
    try {
        ...
        product.sizesEnabled = sizesEnabled !== undefined ? (sizesEnabled === 'true' || sizesEnabled === true) : product.sizesEnabled;
